from domain import User, Category, Topic, Quiz, Question, Choice
...
def main():
    ...
    choice_1 = Choice(question_id=question.id, content="France")
    ...
    print(f"The only correct answer is: {choice_1.content}")
